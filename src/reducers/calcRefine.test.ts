...
describe('Single update test', () => {
  it('should get the correct data', () => {
    ...
    let output1: WeaponInfo[] = dbWeapon
      .chain()
      .find({ name: '手裏剣' })
      .data()
    ...
    calcRefine.updateRefine('手裏剣')
    let output2: WeaponInfo[] = dbWeapon
      .chain()
      .find({ name: '手裏剣' })
      .data()
...
describe('Single update test', () => {
  it('should get the correct data', () => {
    ...
    let output2Atk: number = output2[0].atk
    let output2Ref: number = output2[0].ref
    let output3: WeaponInfo[] = dbWeapon
      .chain()
      .find({ name: '八方手裏剣' })
      .data()
