...
weapons = {
  ...
  data: [
    ["脇差",                "sword",   5, 1, 15, 30, 140, 1, "攻速+30%"]
    ["兜割",                "sword",  12, 1, 16, 30, 140, 1, "攻速+20%"]
    ["太刀",                "sword",  14, 1, 19, 30, 145, 1, "範囲+5"]
    ["打刀",                "sword",  17, 1, 19, 30, 140, 1, ""]
    ["鉄砲切り兼光",        "sword",  20, 1, 16, 30, 140, 2, "攻速+20%"]
    ["破魔の太刀",          "sword",  22, 1, 19, 30, 150, 2, "範囲+10"]
    ["雷切",                "sword",  31, 1, 17, 30, 140, 2, "攻速+10%"]
    ["瓶割刀",              "sword",  35, 1, 19, 30, 140, 2, ""]
    ["清正の邪刀",          "sword",  24, 1, 19, 30, 140, 3, "デバフ付加:移速"]
    ["虎徹",                "sword",  30, 1, 15, 30, 140, 3, "攻速+30%"]
    ["フルンティング",      "sword",  37, 1, 19, 30, 190, 3, "与ダメージの2%耐久が回復"]
    ["長巻",                "sword",  42, 1, 19, 30, 155, 3, "範囲+15"]
    ["古代刀",              "sword",  45, 1, 17, 30, 140, 3, "攻速+10%"]
    ...
    ["真・清正の邪刀",      "sword",  35, 1, 19, 30, 140, 4, "デバフ付加:移速"]
    ["桜花爛漫刀",          "sword",  43, 1, 16, 30, 140, 4, "範囲+10 攻速+20%"]
    ["妖刀村正",            "sword",  48, 1, 16, 30, 140, 4, "攻速+20%"]
    ...
    ["ニライカナイ",        "lance",  25, 2, 57, 30, 200, 4, "速度低下 2連攻撃 デバフ付加:移速"]
    ["桜花爛漫槍",          "lance",  30, 1, 19, 30, 210, 4, "範囲+10 攻速+20%"]
    ["とんぼきり",          "lance",  31, 1, 23, 30, 220, 4, "範囲+20"]
    ["蜻蛉切",              "lance",  35, 1, 19, 30, 200, 4, "攻速+20%"]
    ...
    ["木槌",                "hammer",  6, 1, 21, 30, 100, 1, "攻速+30%"]
    ...
    ["桜花爛漫槌",          "hammer", 36, 1, 23, 30, 110, 4, "範囲+10 攻速+20%"]
    ["打ち出の小槌",        "hammer", 44, 1, 21, 30, 100, 4, "攻速+30%"]
    ["軍配形天守槌",        "hammer", 54, 1, 23, 30, 100, 4, "攻速+20%"]
    ...
    ["桜花爛漫盾",          "shield", 14, 1, 20, 30, 100, 4, "攻速+20% 範囲+10 防禦+41"]
    ...
    ["手裏剣",              "kunai",   8, 1, 22, 22, 220, 1, "攻速上昇 6體攻撃"]
    ["スローイングナイフ",  "kunai",  21, 1, 24, 22, 220, 1, "飛行特攻 3體攻撃"]
    ["苦無",                "kunai",  26, 1, 24, 22, 220, 1, "4體攻撃"]
    ["円戦輪",              "kunai",  38, 1, 27, 22, 240, 1, "攻速低下 範圍+20 2體攻撃"]
    ["四方手裏剣",          "kunai",  16, 1, 22, 22, 220, 2, "攻速上昇 6體攻撃"]
    ["ブーメランダガー",    "kunai",  27, 1, 24, 22, 220, 2, "飛行特攻 3體攻撃"]
    ["忍の苦無",            "kunai",  34, 1, 24, 22, 220, 2, "4體攻撃"]
    ["双刃戦輪",            "kunai",  51, 1, 27, 22, 245, 2, "攻速低下 範圍+25 2體攻撃"]
    ["八方手裏剣",          "kunai",  24, 1, 22, 22, 220, 3, "攻速上昇 6體攻撃"]
    ["ウォシュレ",          "kunai",  34, 1, 24, 22, 220, 3, "飛行特攻 3體攻撃"]
    ["十字苦無",            "kunai",  42, 1, 24, 22, 220, 3, "4體攻撃"]
    ["四方戦輪",            "kunai",  63, 1, 27, 22, 250, 3, "攻速低下 範圍+30 2體攻撃"]
    ["月光の短剣",          "kunai",  30, 1, 20, 22, 220, 4, "飛行特攻 3體攻撃 攻速+20%"]
    ["ダマスキナードナイフ", "kunai", 44, 1, 24, 22, 220, 4, "飛行特攻 3體攻撃"]
    ["夜叉の苦無",          "kunai",  55, 1, 24, 22, 220, 4, "4體攻撃"]
    ["白鏡の戦輪",          "kunai",  84, 1, 27, 22, 260, 4, "攻速低下 範圍+40 2體攻撃"]
    
    ["鏑矢",                "bow",     6, 1, 19, 18, 290, 1, "範囲+10"]
    ["柳葉",                "bow",     9, 1, 17, 18, 280, 1, "攻速+10%"]
    ["破壊の弓",            "bow",    11, 1, 19, 18, 280, 1, ""]
    ["重藤の弓",            "bow",    14, 1, 16, 18, 280, 2, "攻速+20%"]
    ["破魔弓",              "bow",    15, 1, 19, 18, 290, 2, "範囲+10"]
    ["雷の弓",              "bow",    20, 1, 17, 18, 280, 2, "攻速+10%"]
    ["炎の弓",              "bow",    23, 1, 19, 18, 280, 2, ""]
    ["天鹿児弓",            "bow",    24, 1, 16, 18, 280, 3, "攻速+20%"]
    ...
    ["天の羽々矢",          "bow",    29, 1, 15, 18, 280, 4, "攻速+30%"]
    ["桜花爛漫弓",          "bow",    31, 1, 16, 18, 290, 4, "範囲+10 攻速+20%"]
    ["平泉の夏弓",          "bow",    31, 1, 19, 18, 280, 4, "与ダメージの3%耐久が回復"]
    ["聚楽の弓",            "bow",    35, 1, 16, 18, 280, 4, "攻速+20%"]
    ["まどかの弓",          "bow",    38, 1, 19, 18, 300, 4, "範囲+20 矢の着弾速度高速化"]
    ["雷上動",              "bow",    40, 1, 17, 18, 280, 4, "攻速+10%"]
    ...
    ["木弩",                "xbow",   10, 1, 19, 24, 250, 1, "攻速+20%"]
    ["石弩",                "xbow",   28, 1, 24, 24, 250, 1, ""]
    ["東方弩",              "xbow",   54, 1, 24, 24, 250, 2, ""]
    ["高虎の忠弩",          "xbow",   35, 1, 24, 24, 250, 3, "デバフ付加:移速"]
    ["舞鶴",                "xbow",   55, 1, 20, 24, 250, 3, "攻速+20%"]
    ...
    ["真・高虎の忠弩",      "xbow",   51, 1, 24, 24, 250, 4, "デバフ付加:移速"]
    ["桜花爛漫弩",          "xbow",   57, 1, 20, 24, 260, 4, "範囲+10 攻速+20%"]
    ...
    ["桜花爛漫銃",          "arqu",   52, 1, 31, 30, 350, 4, "範囲+10 攻速+20%"]
    ["未来ガジェット1号機", "arqu",   52 1, 37, 30, 340, 4, "敵の移動速度を一瞬だけ0にする"]
    ["八咫烏",              "arqu",   58, 1, 31, 30, 340, 4, "攻速+20%"]
    ["ヴァリス改",          "arqu",   58, 1, 37, 30, 340, 4, "敵の防御を10%無視"]
    ["白鷺の大筒",          "arqu",   60, 1, 33, 27, 340, 4, "攻速+10% 隙を10%短縮"]
    ...
    ["木製大砲",            "cannon",  7, 1, 35, 45, 340, 1, "攻速+20%"]
    ["設置式大筒",          "cannon", 11, 1, 42, 45, 340, 1, ""]
    ["芝辻砲",              "cannon", 16, 1, 35, 45, 340, 2, "攻速+20%"]
    ...
    ["小十郎の響杖",        "spell",  22, 1, 35, 30, 240, 3, "攻速+20%"]
    ["三蔵法師の杖",        "spell",  28, 1, 42, 30, 260, 3, "範囲+20"]
    ["閻魔の筆",            "spell",  36, 1, 42, 30, 240, 3, ""]
    ["ウィズの氷晶",        "spell",  20, 1, 42, 30, 240, 4, "敵の攻撃を下げる"]
    ["桜花爛漫筆",          "spell",  26, 1, 35, 30, 250, 4, "範囲+10 攻速+20%"]
    ["第六天魔王の撹杖",    "spell",  30, 1, 42, 30, 240, 4, "敵の範囲を少し下げる"]
    ["真・小十郎の響杖",    "spell",  31, 1, 35, 30, 240, 4, "攻速+20%"]
    ["菩薩の杖",            "spell",  37, 1, 42, 30, 260, 4, "範囲+20"]
    ["道風の筆",            "spell",  42, 1, 38, 30, 240, 4, "攻速+10%"]
