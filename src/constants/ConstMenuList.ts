...
export const menuBuffList: MenuList[] = [
  ...
  {
    id: 'select-buffSpeedPre',
    label: '攻撃速度上昇(%)',
    value: 'buffSpeedPre'
  },
  {
    id: 'select-buffSpeedPost',
    label: '攻撃後の隙短縮(%)',
    value: 'buffSpeedPost'
  },
  {
    id: 'select-buffDamageUp',
    label: 'ダメージが上昇(%)',
    value: 'buffDamageUp'
  },
  {
    id: 'select-buffDirectUp',
    label: '直撃ボーナス上昇(%)',
    value: 'buffDirectUp'
  },
  {
    id: 'select-buffHitnumber',
    label: '攻撃対象数上昇',
    value: 'buffHitnumber'
  },
  {
...
export const menuEnemyList: MenuList[] = [
  ...
  {
    id: 'select-enemyDefPercent',
    label: '防禦力減少%',
    value: 'enemyDefPercent'
  },
  { id: 'select-enemyDefNumber', label: '防禦力減少', value: 'enemyDefNumber' },
  {
    id: 'select-enemyDamageUp',
    label: '被ダメージが上昇(%)',
    value: 'enemyDamageUp'
  }
]
